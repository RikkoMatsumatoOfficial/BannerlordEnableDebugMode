            ...
            for file in f:
                ...
                if(confirm == "y"):
                    ...
                    if(p.Path("C:\\Users\\{}\\Documents\\Mount and Blade II Bannerlord".format(username) + "\\Configs\\engine_config.txt")):
                        ...
                        file_attribution.SetFileAttribute("C:\\Users\\{}\\Documents\\Mount and Blade II Bannerlord".format(username) + "\\Configs\\engine_config.txt", 0x1) # 0x1 is Only Read File!!!
